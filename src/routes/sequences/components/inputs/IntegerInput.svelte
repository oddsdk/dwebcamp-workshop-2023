...
<input
  type="text"
  class="p-2 bg-base-100 rounded-sm outline-none text-heading-lg text-center border border-neutral-200 dark:border-neutral-700 focus:border-neutral-500 dark:focus:border-neutral-500"
