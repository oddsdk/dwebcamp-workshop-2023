...
<div class="flex min-h-[80vh] min-w-full justify-center items-center">
  <div class="min-w-[50vw] flex flex-col items-center text-center text-body-lg">
    ...
    <div class="flex justify-center my-16 text-odd-green-500 dark:text-odd-green-300">
      <WelcomeCheckIcon />
    </div>
      <p class="mb-4">Your account has been created.</p>
      <p class="mb-8">
        Your account & data live only on your devices. We recommend connecting at least one additional
        device.
      </p>
      <a
      ...
      <div class="">
        ...
        <p class="text-body-m hidden peer-checked:block">
          You don't need a password! {appName} uses public key cryptography to authenticate you with this
          device.
        </p>
      </div>
  </div>
